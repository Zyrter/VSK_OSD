    ...
    if(mavlink_parse_char(MAVLINK_COMM_0, c, &msg, &status)) {
      ...
      case MAVLINK_MSG_ID_SYS_STATUS:
        {
          ...
          if(osd_vbat_A < 5.0f){
            batt_cell = 1;
            batt_warn_level = 3.5f; 
          } 
          else if (osd_vbat_A < 8.5f){
            batt_cell = 2;
            batt_warn_level = 7.0f; 
          }
          else if (osd_vbat_A < 12.8f){
            batt_cell = 3;
            batt_warn_level = 10.5f; 
          } 
          else if (osd_vbat_A < 17.0f){
            batt_cell = 4;
            batt_warn_level = 14.0f; 
          } 
          else if (osd_vbat_A < 21.3f){
            batt_cell = 5;
            batt_warn_level = 17.5f; 
          } 
          else if (osd_vbat_A < 25.8f){
            batt_cell = 6;
            batt_warn_level = 21.0f; 
          }
        }
        break;
      ...
      case MAVLINK_MSG_ID_VSKYLINE_OSD_STATUS:
        {
          ...
          //PID setup
            ...
            panel = 4;
            subpage = 5;
            pos_line = (int8_t)(page_id & 0x00ff);
          }
          //IMU setup
          ...
          //                    Serial.printf("Radio status %d ", rssi2);
          osd_display = mavlink_msg_vskyline_osd_status_get_osd_display(&msg);
          Serial.print(osd_display);
      ...
      case MAVLINK_MSG_ID_VSKYLINE_PID_SETUP:
        {                   
          ...
          //var type float (carefull)
          profile = mavlink_msg_vskyline_pid_setup_get_profile(&msg);
          pid_type = mavlink_msg_vskyline_pid_setup_get_pid_type(&msg);                    
        ...
        break;
      case MAVLINK_MSG_ID_VSKYLINE_RC_SETUP:
        {
          tpa = mavlink_msg_vskyline_rc_setup_get_tpa(&msg);
          tpa_bp = mavlink_msg_vskyline_rc_setup_get_tpa_breakpoint(&msg);
          p_expo = mavlink_msg_vskyline_rc_setup_get_pitch_expo(&msg);
          p_rate = mavlink_msg_vskyline_rc_setup_get_pitch_rate(&msg);
          r_expo = mavlink_msg_vskyline_rc_setup_get_roll_expo(&msg);
          r_rate = mavlink_msg_vskyline_rc_setup_get_roll_rate(&msg);
          y_expo = mavlink_msg_vskyline_rc_setup_get_yaw_expo(&msg);
          y_rate = mavlink_msg_vskyline_rc_setup_get_yaw_rate(&msg);
        }
        break;
      default:
        //Do nothing
